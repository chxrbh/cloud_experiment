...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--show-figures", action="store_true", help="Deprecated: experiment runners no longer generate figures; use scripts/plot_experiments.py.")
...
def main() -> None:
    ...
    print(f"Done. P3 results written to {args.results_dir}/. Public figures are generated by scripts/plot_experiments.py.")
