...
own sealed fog-scoped key.
    ...
    The edge gateway rebroadcasts an HMAC-authenticated 280-byte gossip summary to downstream sensors every $T_g=500\,\text{ms}$ ($\approx0.56\,\text{KB/s}$, negligible on 20~Mbps or higher links).
